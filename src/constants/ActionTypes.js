...
export const USER_DOMICILE = 'USER_DOMICILE';
export const USER_DOMICILE_SUCCESS= 'USER_DOMICILE_SUCCESS';

export const UPDATE_BASIC = 'UPDATE_BASIC';
export const UPDATE_BASIC_SUCCESS= 'UPDATE_BASIC_SUCCESS';
